...
import { Accordion, AccordionSummary, AccordionDetails, Typography, Grid, TextField, FormControl, InputLabel, Select, MenuItem, Button } from '@mui/material';
import ExpandMoreIcon from '@mui/icons-material/ExpandMore';
import { fetchSubjects, fetchProjects } from '/src/LearnLeaf_Functions.jsx';
...
const TaskFilterBar = ({ filterCriteria, setFilterCriteria, clearFilters }) => {
    ...
    useEffect(() => {
        (async () => {
            ...
            setsubjects(await fetchSubjects(user.id));
                    ...
                    <Grid container item spacing={3} xs={12}>
                        ...
                        <Grid item xs={12} sm={4} className="filter-item">
                            <Grid container spacing={2} direction="column">
                                ...
                                <Grid item>
                                    <FormControl fullWidth variant="outlined">
                                        <InputLabel id="subjectFilterLable">Subject</InputLabel>
                                        <Select
                                            labelId="subjectFilterLable"
                                            id="subjectFilter"
                                        ...
                                        >
                                            ...
                                            {subjects?.map((subject) => (
                                                <MenuItem key={subject.id} value={subject.subjectName}>{subject.subjectName}</MenuItem>
                                            ))
                                            }
                                            {/* <MenuItem value="Not Started">Not Started</MenuItem>
                                            <MenuItem value="In Progress">In Progress</MenuItem>
                                ...
                                <Grid item>
                                    <FormControl fullWidth variant="outlined">
                                        <InputLabel id="projectFilterLable">Project</InputLabel>
                                        <Select
                                            labelId="projectFilterLable"
                                            id="projectFilter"
                                            value={filterCriteria.project}
                                            onChange={(e) => setFilterCriteria({ ...filterCriteria, project: e.target.value })}
                                            label="Project"
                                        >
                                            <MenuItem value="">Show All</MenuItem>
                                            {projects?.map((project) => (
                                                <MenuItem key={project.id} value={project.projectName}>{project.projectName}</MenuItem>
                                            ))
                                            }
                                            {/* <MenuItem value="Not Started">Not Started</MenuItem>
                                            <MenuItem value="In Progress">In Progress</MenuItem>
