            ...
            {filtered.map(subject => (
              <div key={subject.subjectId} className="ll-card"
                ...
                <button onClick={() => handleViewDetails(subject)}
                  ...
                  <h3 style={{ margin:"0 0 4px", fontSize:"1rem", fontWeight:700, color:subject.subjectColor||"#355147", lineHeight:1.3,
                ...
                {subject.subjectDescription && (
                  <p style={{ margin:"0 0 12px", fontSize:"0.8rem", color:"#6b7280", lineHeight:1.4,
